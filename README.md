...
- Встроенный дашборд с 17 вкладками аналитики
...
├── models.py              — 18 SQLAlchemy моделей + User, ApiKey, WbToken, UserCabinetAccess
├── schemas.py             — Pydantic-схемы
└── database.py            — Подключение к PostgreSQL

static/
├── dashboard.html         — Оболочка дашборда (auth-aware UI)
